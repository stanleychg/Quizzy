...
public class QuizDatabaseManager {
		...
		public QuizDatabaseManager (Context context, String dbName)
		{
			myContext = context;
			this.dbName = dbName;
		}
		
		public QuizDatabaseManager open(boolean isWriteable) throws SQLException
		{
			dbQuiz = new QuizDatabase(myContext,dbName);
			if (isWriteable)
